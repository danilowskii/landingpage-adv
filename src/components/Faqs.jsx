...
export default function Faqs() {
  ...
  const faqs = [
    ...
    {
      question: "Quais documentos devo levar na reunião?",
      answer:
    ...
    <section className="py-24 relative z-10">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h3 className="text-3xl md:text-5xl font-bold text-white font-serif">
          ...
          {faqs.map((faq, index) => (
            <div
              ...
              className={`
                  ...
                  ${
                    openFaq === index
                      ? "bg-slate-900/80 border-amber-500/50 shadow-[0_0_30px_rgba(245,158,11,0.15)]"
            ...
            >
              ...
              >
                <span
                  className={`font-serif text-lg font-bold transition-colors duration-300 ${
                    openFaq === index ? "text-amber-500" : "text-slate-200"
                  }`}
                >
                  {faq.question}
                </span>
              ...
              <div
                className={`
                    px-6 text-slate-400 leading-relaxed transition-all duration-500 ease-in-out
                    ${
                      openFaq === index
